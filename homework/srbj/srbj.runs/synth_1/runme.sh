...
HD_PWD='C:/Users/zhan/vivado-repo/srbj/srbj.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log srbj.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source srbj.tcl
